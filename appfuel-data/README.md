...
This folder is the installable `appfuel-data` skill. Agent clients discover the skill from `SKILL.md`; the other files are supporting resources that the agent can read when `SKILL.md` routes it to them.
